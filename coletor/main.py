...
while(1):
    ...
    while(requisicao_feita == False):
        ...
        try:
            ...
            time.sleep(2)
            print("Aguardando 1 minuto para fazer uma nova requisicao...\n")
            time.sleep(60)
        else:
    ...
    while(arquivo_diario_salvo == False):
        try:
            ...
            df_diario.sort_values(by=['id_sasi']).to_excel(nome_arquivo_diario,index=False)

        except:
            print("Houve um erro no momento de salvar o excel diario (¬¬) \n")
            time.sleep(2)
            print("Aguardando 1 minuto para tentar salvar novamente...\n")
            time.sleep(60)
    ...
    while(arquivo_geral_salvo == False):
        try:
            ...
            df_atual.sort_values(by=['id_sasi']).to_excel('/home/thiago/Documentos/notebooks/planilha_geral/dados_cartao_total.xlsx',index=False)
    ...
    while(banco_fechado == False): 
        try:
            ...
            time.sleep(2)
            print("Aguardando 1 minuto para tentar novamente...\n")
            time.sleep(60)
        else:
